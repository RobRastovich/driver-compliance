...
function ResetForm() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setDone(true)
      setTimeout(() => router.push('/company/login'), 2500)
    } catch {
  ...
  if (!token) {
    return (
      <div className="text-center space-y-3">
        ...
        <Link href="/company/forgot-password" className="text-brand-600 hover:underline text-sm">Request a new one</Link>
      </div>
    )
  }
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Choose a strong password for your company account</p>
        </div>
